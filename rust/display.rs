...
impl fmt::Display for Complex {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        write!(f, "{real} {sign} {imag}i", real=self.real, imag=self.imag.abs(), sign=sign)
    }
}
...
fn main() {
    ...
    println!("Compare complex: {:#}", complex);
    println!("Display: {:?}", complex);

    let complex2 = Complex { real: 3.3, imag: -7.2 };
    println!("Compare complex: {:#}", complex2);
